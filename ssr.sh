...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/syntax-er0r/Projectbaru/main/ssrmu.sh"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/syntax-er0r/Projectbaru/main/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://raw.githubusercontent.com/syntax-er0r/Projectbaru/main/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://raw.githubusercontent.com/syntax-er0r/Projectbaru/main/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/xp-ssr https://raw.githubusercontent.com/syntax-er0r/Projectbaru/main/xp-ssr.sh && chmod +x /usr/bin/xp-ssr
wget -O /usr/bin/renewssr https://raw.githubusercontent.com/syntax-er0r/Projectbaru/main/renewssr.sh && chmod +x /usr/bin/renewssr
