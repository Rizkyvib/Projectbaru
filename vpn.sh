...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/syntax-er0r/Projectbaru/main/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://github.com/syntax-er0r/Projectbaru/raw/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
...
cd
# pada tulisan xxx https://raw.githubusercontent.com/syntax-er0r/Projectbaru dengan alamat ip address VPS anda 
/etc/init.d/openvpn restart
...
iptables -t nat -A POSTROUTING -s 10.6.0.0/24 -o $ANU -j SNAT --to 34.126.100.97
iptables -t nat -A POSTROUTING -s 10.7.0.0/24 -o $ANU -j SNAT --to 34.126.100.97
END
